...
#############################################################################
rseed  = 1000           # random generator seed
t_sim  = 5000.0         # simulation time
...
w_ex  = frac*0.15 	# mV
w_in  = -g * w_ex	# a fraction g of the excitatory synaptic weight
delay = 1.5 		#in ms
...
#############################################################################
I_ext       = 100.0#100.0 # constant current in (pA)
