...
def evaluate(post_list):
    ...
    while (trun < t_sim):
        ...
        if unif <= phi_u[id_min]:
            ...
            Iaux_id = I_syn[post_list[id_min][0]]>0.0
            phi_u[post_list[id_min][0]][Iaux_id] = phi(V[post_list[id_min][0]][Iaux_id]+I_syn[post_list[id_min][0]][Iaux_id]/(beta-alpha), gamma, r)
            phi_u[post_list[id_min][0]][~Iaux_id] = phi(V[post_list[id_min][0]][~Iaux_id], gamma, r)
